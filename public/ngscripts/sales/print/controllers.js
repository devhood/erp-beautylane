angular.module('salesPrintApp.controllers',[])
.controller('SalesPrintListController',function($scope,$state,popupService,$window,Sales, $filter,DTOptionsBuilder, DTColumnBuilder){
...
}).controller('SalesPrintViewController',function($scope,$stateParams,Sales, Api){
...
}).controller('SalesPrintCreateController',function($scope,$state,$stateParams,Sales,Api){
...
}).controller('SalesPrintEditController',function($scope,$window,popupService,$state,$stateParams,Sales, Api){
